...
--
-- Host: localhost
-- Generation Time: Jun 27, 2016 at 12:01 AM
...
(9, 5, '3', '200911336', 'ok', '0', '2014-09-17 16:02:43');
...
(5, 1, 12, '1', 'Bab I', '55MAKALAH DAPSON.docx', '2014-09-17 15:59:55');
...
ALTER TABLE `mahasiswa`
 ADD PRIMARY KEY (`mNim`);

--
-- Indexes for table `periode`
--
ALTER TABLE `periode`
 ADD PRIMARY KEY (`pTahun`);
...
--
-- Indexes for table `ujian_hasil`
--
ALTER TABLE `ujian_hasil`
 ADD PRIMARY KEY (`sId`);

--
-- Indexes for table `ujian_meja`
--
ALTER TABLE `ujian_meja`
 ADD PRIMARY KEY (`sId`);

--
-- Indexes for table `ujian_proposal`
--
ALTER TABLE `ujian_proposal`
 ADD PRIMARY KEY (`sId`);
...
--
ALTER TABLE `dosen`
MODIFY `id_dosen` int(9) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=19;
--
-- AUTO_INCREMENT for table `info`
--
ALTER TABLE `info`
MODIFY `iId` int(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT for table `jadwal`
--
ALTER TABLE `jadwal`
MODIFY `jId` int(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT for table `jurusan`
--
ALTER TABLE `jurusan`
MODIFY `jId` int(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `kampus`
--
ALTER TABLE `kampus`
MODIFY `kId` int(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `komentar`
--
ALTER TABLE `komentar`
MODIFY `kkId` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT for table `konsultasi`
--
ALTER TABLE `konsultasi`
MODIFY `kId` int(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
